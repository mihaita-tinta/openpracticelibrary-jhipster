...
import { sampleWithRequiredData } from '../blog-item.test-samples';
...
describe('BlogItem Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, BlogItemComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.blogItems?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to blogItemService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBlogItemIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBlogItemIdentifier).toHaveBeenCalledWith(entity);
