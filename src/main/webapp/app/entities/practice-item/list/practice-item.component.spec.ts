...
import { sampleWithRequiredData } from '../practice-item.test-samples';
...
describe('PracticeItem Management Component', () => {
  let comp: PracticeItemComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PracticeItemComponent],
      providers: [
        {
      ...
      .overrideTemplate(PracticeItemComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.practiceItems?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to practiceItemService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPracticeItemIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPracticeItemIdentifier).toHaveBeenCalledWith(entity);
