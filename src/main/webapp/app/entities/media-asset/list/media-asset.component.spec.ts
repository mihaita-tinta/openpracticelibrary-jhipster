...
import { sampleWithRequiredData } from '../media-asset.test-samples';
...
describe('MediaAsset Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, MediaAssetComponent],
      providers: [
        {
      ...
      .overrideTemplate(MediaAssetComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to mediaAssetService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMediaAssetIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMediaAssetIdentifier).toHaveBeenCalledWith(entity);
