...
type TagFormGroupContent = {
  ...
  content: FormControl<ITag['content']>;
  practiceItem: FormControl<ITag['practiceItem']>;
};
...
export class TagFormService {
  createTagFormGroup(tag: TagFormGroupInput = { id: null }): TagFormGroup {
    ...
    return new FormGroup<TagFormGroupContent>({
      ...
      content: new FormControl(tagRawValue.content),
      practiceItem: new FormControl(tagRawValue.practiceItem),
    });
  }
